...
const OurStory: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <div className="flex flex-col w-full gap-2 md:justify-start md:items-start md:gap-5">
          <div
      ...
      <div ref={racesWrapperRef} className="w-full h-auto racesWrapper">
        <div
          ref={racesRef}
      ...
      <div className="z-[4] container mx-auto w-full flex flex-col justify-center items-center lg:px-[11rem] px-[1rem]">
        <div className="flex flex-col w-full gap-2 md:justify-start md:items-start md:gap-5">
          <div
            className="md:max-w-[120px] max-w-[130px] md:py-1 md:px-5 py-4 px-7 border-[1.4px] border-[#2A286B] rounded-full text-black"
            data-aos="flip-left"
          ...
          <div className="grid items-start justify-between w-full grid-cols-1 gap-10 mt-10 md:grid-cols-2 lg:grid-cols-3 md:flex-row">
            <div
              className="group relative w-full md:h-[45rem] h-[60rem] bg-[#141333] flex flex-col justify-between items-start rounded-[3rem]   bg-no-repeat bg-cover group-hover:scale-105 transition-transform duration-500 ease-in-out md:py-5 py-10 px-16 pb-20"
              data-aos="fade-right"
            >
            ...
            <div
              className="group relative w-full md:h-[45rem] h-[60rem] bg-[#000] flex flex-col justify-start items-start rounded-[3rem]   bg-no-repeat bg-cover group-hover:scale-105 transition-transform duration-500 ease-in-out md:py-5 py-10 px-16 pb-20 overflow-hidden"
              data-aos="fade-right"
            >
              {/* <div className="absolute md:w-24 md:h-24 w-28 h-28 right-0 bottom-0 rounded-tl-[3rem] bg-[#fbfbfb] ">
								<span className="absolute z-50 p-4 transition-all duration-300 ease-linear bg-blue-600 rounded-full bottom-2 right-2 group-hover:bg-black group-hover:text-white">
									<ArrowUpRight />
								</span>
								<div
            ...
            <div
              className="group relative col-span-2 w-full md:h-[45rem] h-[60rem] bg-[#000] flex flex-col justify-between items-start rounded-[3rem]   bg-no-repeat bg-cover group-hover:scale-105 transition-transform duration-500 ease-in-out md:py-5 py-10 px-16 pb-20"
              // data-aos="fade-right"
              style={{
