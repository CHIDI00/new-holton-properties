	...
	return (
		<div className="container mx-auto md:px-[11rem] px-6">
			...
			>
				...
				<button className="md:w-full w-full bg-blue-700 text-3xl rounded-full text-white font-semibold py-7 px-8  hover:bg-[#4f6fc9] transition-all ease-in-out duration-300">
					Search
				</button>
			</form>
		</div>
