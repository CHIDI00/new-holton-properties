...
const TheTeam: React.FC = () => {
  return (
    <div
      id="meet-the-team"
      className="w-full flex flex-col justify-center items-center md:pb-48 pb-28 bg-[#fbfbfb]"
    >
      <div className="container mx-auto">
        ...
        <div className="mx-auto lg:w-[80%] w-full flex justify-center items-center">
          <InfiniteMovingCards
            items={teamData}
            direction="right"
            speed="normal"
