	...
	return (
		<div className="w-full md:h-[80rem] py-32 flex justify-center items-center">
			<div className="container md:px-[11rem] md:h-full flex flex-col md:flex-row justify-between items-center mx-7 gap-20">
				...
				<div
					className="group relative md:h-full w-full md:w-[45%] h-[40rem] bg-white flex flex-col justify-between items-start rounded-[3rem] bg-no-repeat bg-left-bottom p-5 hover:bg-blue-800 transition-all duration-300 ease-linear overflow-hidden"
					style={{
				...
				<div className="w-full md:w-[50%] md:h-full flex flex-col justify-start items-start  md:gap-10 ">
					<div className="w-full md:flex flex flex-col justify-start items-start gap-5">
						{/* <div
						...
						<div className="w-full hidden md:flex justify-start items-start gap-5">
							<div
