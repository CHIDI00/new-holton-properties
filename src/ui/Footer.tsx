...
const Footer: React.FC = () => {
	return (
		...
		>
			...
			<div className="absolute w-full h-20 bg-[#fbfbfb] rounded-b-[5rem] z-10 -top-1"></div>
			...
			<div className="flex flex-col justify-center items-center">
				...
				<Magnet padding={50} disabled={false} magnetStrength={3}>
					<div className="w-[150px] h-[150px] flex justify-center items-center bg-[#111111a2] border-[1px] border-gray-600 backdrop-blur-xl rounded-full text-white p-6">
			...
			<div className="w-[97%] md:mb-[-250px] mb-[-120px] md:mt-[-100px] mt-[-30px] flex justify-center items-center z-[4]">
				<h1 className="md:text-[40rem] text-[20rem] leading-none bg-gradient-to-b from-[rgba(255,255,255,0.47)] to-[rgba(0,0,0,0.2)] bg-clip-text text-transparent">
					holton
				</h1>
			</div>

			<div className="mt-[6rem] md:w-[97%] md:h-[45rem] w-[93%] bg-white z-10 rounded-[3rem] flex flex-col justify-center items-center md:px-[2rem] md:py-0 p-[2rem]">
